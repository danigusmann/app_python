import os
import sqlite3
from flask import Flask, render_templante, request, redirect, url_for, jsonify
...
def init_db():
    ...
    conn.execute('CREATE TABLE IF NOT EXISTS alunos (id INTEGER PRIMARY KEY AUTOINCREMENT, nome TEXT NOT MULL, curso TEXT NOT MU)')
    conn.commit()
    conn.close()
